...
import team.sjfw.monitoringSystem.log.config.ExecuteSqlFileLogConfig;

@Configuration
@Import({GlobalProperties.class,ExecuteSqlFileLogConfig.class})
@ComponentScan(basePackages = {"team.sjfw.monitoringSystem.controller"})
//@EnableAspectJAutoProxy(exposeProxy=true,proxyTargetClass=true)

public class ExecuteSqlFileConfig {
}
